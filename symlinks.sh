...
files="bashrc zprofile  vimrc vim zshrc codeblocks irssi synaptic symlinks.sh bash_aliases gitconfig AndroidStudio"    # list of files/folders to symlink in homedir
